package net.abumarkub.app_midibridge
{
	...
	public class AppWeb extends Sprite
	{
		...
		public function init():void
		{
			...
			_midiSystem.addEventListener(MidiEvent.NOTE_ON, handleMidiEvent);
			_midiSystem.addEventListener(MidiEvent.NOTE_OFF, handleMidiEvent);
